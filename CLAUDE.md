...
### Regla d'or del Testing
**Sempre** que s'afegeixi una nova funcionalitat, és **obligatori** incloure els seus tests (unitaris, integració o E2E segons correspongui). Això garanteix que el CI/CD detecti qualsevol regressió en futures modificacions.
